                     ...
                     <table class="table table-hover table-condensed">
                        ...
                        <tbody>
                            <?php 
                                 if(isset($_SESSION["shopping_cart"])){
                            ?>        
                           <form action='<?php echo BASE_URL ?>/giohang/update_giohang' method="post">
                              <?php
                                    $total = 0;
                              ...
                              <tr class="tr">
                                 ...
                                 <td class="actions aligncenter" data-th="">
                                        <button type="submit" style="box-shadow: none" name="delete_cart" value="<?php echo $value['product_id'] ?>" class="btn btn-sm btn-warning">Xoá</button>

                                      <button type="submit" style="box-shadow: none" name="update_cart" value="<?php echo $value['product_id'] ?>" class="btn btn-sm btn-primary">Cập nhật</button>                       
                                 </td>
                              </tr>
                              <?php 
                                 }
                           ...
                           <?php 
                              ...
                              <tr>
                                 <td colspan="7" >
                                    <div class="sum_price_all">
                                       <span class="text_price">Giỏ hàng rỗng</span> 
