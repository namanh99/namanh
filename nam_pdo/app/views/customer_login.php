         ...
         <?php 
            ...
            if(!empty($_GET['msg'])){
              ...
              foreach ($msg as $key => $value){
                echo '<span style="color:red;font-weight:bold;font-size:18px">'.$value.'</span>';
              }
            }
         ?>
         <form autocomplete="off" action="<?php echo BASE_URL ?>/khachhang/insert_dangky" method="POST" >
                           ...
                           <div class="content-box_contact">
                              ...
                              <div class="row">
                                 <div class="input">
                                    ...
                                    <input type="password" name="txtMatKhau" required class="clsip">
                                 </div>
                                 <div class="clear"></div>
                              </div>
                              <!---row---->
