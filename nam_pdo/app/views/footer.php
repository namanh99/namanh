<div class="clear"></div>
                ...
                <div class="footer footer_bottom">
                    ...
                    <div class="footer-col">
                        ...
                        <div class="footer-col-content">
                            <ul class="social">
                                <li>
                                    <a href="#" class="fb"><img src="<?php echo BASE_URL ?>/public/template/images/Fb.png">Facebook</a>
                                </li>
                                <li>
                                    <a href="#" class="fb"><img src="<?php echo BASE_URL ?>/public/template/images/Gg.png">Google</a>
                                </li>
                            </ul>
                            <div class="clear"></div>
                        </div>
            ...
            <div class="bg_in">
                <div class="footer">
                    <div class="infor_company">
                        ...
                        <a href=""><img src="<?php echo BASE_URL ?>/public/template/images/logo_cuoi.png"  class="cangiua" /></a>
    ...
    <script defer type="text/javascript" src="<?php echo BASE_URL ?>/public/template/js/jquery.avatarme-1.0.min.js"></script>
    <script src="<?php echo BASE_URL ?>/public/template/js/cloudzoom.js"></script>
    <script defer src="<?php echo BASE_URL ?>/public/template/js/jquery.scrollto.js"></script>
    <script src="<?php echo BASE_URL ?>/public/template/js/jquery.min.js"></script>
    <script defer type="text/javascript" src="<?php echo BASE_URL ?>/public/template/js/sweet-alert.js"></script>
    <script defer type="text/javascript" src="<?php echo BASE_URL ?>/public/template/js/bootstrap.js"></script>
    <script defer type="text/javascript" src="<?php echo BASE_URL ?>/public/template/js/jquery.flexslider-min.js"></script>
    <script defer src="<?php echo BASE_URL ?>/public/template/js/owl.carousel.min.js" type="text/javascript"></script>
    <script defer src="<?php echo BASE_URL ?>/public/template/js/jquery.lazyload.min.js" type="text/javascript"></script>
    <script defer type="text/javascript" src="<?php echo BASE_URL ?>/public/template/js/script_ex.js"></script>
    <script defer type="text/javascript" src="<?php echo BASE_URL ?>/public/template/js/script_menu.js"></script>
    <!-- <link rel="stylesheet" type="text/css" href="template/Default/js/sweet-alert.css"/> -->
    <link rel="stylesheet" href="<?php echo BASE_URL ?>/public/template/css/font-awesome.min.css" type="text/css" />
    <script defer src="<?php echo BASE_URL ?>/public/template/js/owl.carousel.js" type="text/javascript"></script>
    <!-- link rel="stylesheet" href="template/Default/css/responsive.css" type="text/css" /> -->
    <link async rel="stylesheet" href="<?php echo BASE_URL ?>/public/template/css/cssfooter.css" />
    ...
    <div style="display: none;left: 70%;margin-left: -309px;z-index: 1002;position: fixed;top: 40%;margin-top: 0px;" id="loadding">
        <img src="<?php echo BASE_URL ?>/public/template/image/loader.gif" />
    </div>
</body>
