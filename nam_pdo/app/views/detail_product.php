<?php 
   foreach ($detail_product as $key => $value) {
       $name_product = $value['title_category_product'];
        $id_cate = $value['id_category_product'];
   }
   ?>
<section>
   <?php foreach ($detail_product as $key => $detail) {
      ?>
            ...
            <div class="breadcrumbs">
               <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                  ...
                  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                     ...
                     <span itemprop="name"><?php echo $name_product ?></span></a>
                     <meta itemprop="position" content="2" />
                  </li>
                  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                     <span itemprop="item">
                     <strong itemprop="name">
                     <?php echo $detail['title_product'] ?>
                     </strong>
                     </span>
            ...
            <div class="content_page">
               <div class="content-right-items margin0">
                  <div class="title-pro-des-ct">
                     <h1><?php echo $detail['title_product'] ?></h1>
                  </div>
                  ...
                  <div class="content-des-pro">
                     <div class="content-des-pro_in">
                        <div class="pro-des-sum">
                           ...
                           <div class="color_price">
                              <span class="title_price bg_green">Giá bán</span > <?php echo number_format($detail['price_product'],0,',','.').' đ' ?></span> (GIÁ CHƯA VAT)
                              <div class="clear"></div>
                           </div>
                        </div>
                        <div class="clear"></div>
                     ...
                     <div class="ct">
                        ...
                        <div >
                           ...
                           <button class=" fa fa-shopping-cart  btn btn-primary btn-lg  " type="submit" style ="font-size: 19px"> Mua hàng</button>
                           
                            <!-- <input type="submit" class="fa fa-shopping-cart"  name="addcart" value="Đặt hàng">  -->
                           </a>
                  ...
                  <div class="content-des-pro-suport">
                     ...
                     <div class="bx-contact">
                        ...
                        <p><img alt="icon skype " src="<?php echo BASE_URL ?>/public/template/images/icon skype.png" style="height:24px; width:24px" />&nbsp;<a href="skype:quangtran.123corp?chat">thietbivanphong.com</a></p>
                        <p><img alt="icon skype " src="<?php echo BASE_URL ?>/public/template/images/icon skype.png" style="height:24px; width:24px" />&nbsp;<a href="skype:quangtran.123corp?chat">thietbivanphong.com</a></p>
                        <p><img alt="icon skype " src="<?php echo BASE_URL ?>/public/template/images/icon skype.png" style="height:24px; width:24px" />&nbsp;<a href="skype:quangtran.123corp?chat">thietbivanphong.com</a></p>
